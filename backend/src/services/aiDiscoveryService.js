...
exports.AIDiscoveryService = void 0;
const index_1 = require("../index");
// Helper function to get configuration from database
function getConfig(key) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const config = yield index_1.prisma.systemConfig.findUnique({
                where: { key }
            });
...
function callClaudeAPI(prompt) {
    return __awaiter(this, void 0, void 0, function* () {
        const CLAUDE_API_KEY = (yield getDecryptedConfig('Claude_API_Key')) || (yield getDecryptedConfig('CLAUDE_API_KEY'));
...
class AIDiscoveryService {
     ...
     */
    static startDiscoverySession(userId, industry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const initialResponse = yield this.generateIndustryIntroduction(industry);
     ...
     */
    static generateIndustryIntroduction(industry) {
        return __awaiter(this, void 0, void 0, function* () {
            const introductions = {
...
What specific area of healthcare would you like to explore? I can provide market analysis and customer insights.`
            ...
            return introductions[industry.toLowerCase()] ||
     ...
     */
    static getProductVerticals(industry) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const claudeResponse = yield callClaudeAPI(prompt);
     ...
     * Build Claude prompt for product vertical discovery
     */
    static buildProductVerticalDiscoveryPrompt(industry) {
...
Make sure the JSON is valid and properly formatted. Include 3-5 product verticals for this industry.`;
     ...
     * Parse Claude's response into structured product verticals
     */
    static parseClaudeProductVerticals(claudeResponse, industry) {
        var _a;
        try {
            const content = (_a = claudeResponse.content[0]) === null || _a === void 0 ? void 0 : _a.text;
            ...
            return verticals.map((vertical, index) => ({
                ...
                customerTypes: (vertical.customerTypes || []).map((ct, ctIndex) => ({
     ...
     */
    static getMockProductVerticals(industry) {
        const verticals = {
            'dental': [
                {
                    id: 'cbct',
        ...
        return verticals[industry.toLowerCase()] || [];
    }
    /**
     * Add user message to discovery session
     */
    static addUserMessage(sessionId, message, industry, productVertical) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const aiResponse = yield this.generateAIResponse(sessionId, message, industry, productVertical);
            const aiMessage = {
                id: `msg_${Date.now() + 1}`,
                role: 'assistant',
            ...
            const updatedSession = Object.assign(Object.assign({}, existingSession), { conversationHistory: [...existingSession.conversationHistory, userMessage, aiMessage], updatedAt: new Date() });
     ...
     */
    static generateCustomerInsights(industry, productVertical) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                ...
                const content = ((_a = claudeResponse.content[0]) === null || _a === void 0 ? void 0 : _a.text) || this.getFallbackCustomerInsights(industry, productVertical);
                return {
                    content: content,
                    metadata: {
                        industry: industry,
     ...
     * Build Claude prompt for self-prompting analysis
     */
    static buildSelfPromptingAnalysisPrompt(industry, productVertical) {
...
Format your response as if you're conducting a thorough market analysis and sharing your findings. Be conversational but analytical.`;
     ...
     */
    static getFallbackCustomerInsights(industry, productVertical) {
        const insights = {
            'food_beverage': {
...
- Strong growth in dental specialty markets`
        ...
        const industryInsights = insights[industry.toLowerCase()];
        const verticalInsights = industryInsights === null || industryInsights === void 0 ? void 0 : industryInsights[productVertical.toLowerCase()];
     ...
     */
    static generateAIResponse(sessionId, userMessage, industry, productVertical) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                ...
                const content = ((_a = claudeResponse.content[0]) === null || _a === void 0 ? void 0 : _a.text) || this.getFallbackResponse(userMessage, industry, productVertical);
                ...
                const hasExplicitFollowUpRequest = followUpKeywords.some(keyword => userMessage.toLowerCase().includes(keyword));
                let additionalAnalysis = null;
                if (hasExplicitFollowUpRequest) {
                    additionalAnalysis = yield this.generateFollowUpAnalysis(userMessage, industry, productVertical);
                }
     ...
     */
    static generateFollowUpAnalysis(userMessage, industry, productVertical) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                ...
                const hasExplicitRequest = explicitKeywords.some(keyword => userMessage.toLowerCase().includes(keyword));
...
Keep the analysis concise but thorough. Focus on practical insights that help with customer discovery.`;
                const claudeResponse = yield callClaudeAPI(prompt);
                const analysis = (_a = claudeResponse.content[0]) === null || _a === void 0 ? void 0 : _a.text;
                return analysis ? `\n\n**Detailed Analysis:**\n${analysis}` : null;
            }
            catch (error) {
     ...
     */
    static buildConversationPrompt(userMessage, industry, productVertical) {
...
Format your response as: [Brief answer] + [1-2 follow-up questions to continue the conversation]`;
     ...
     */
    static getFallbackResponse(userMessage, industry, productVertical) {
        const responses = [
     ...
     */
    static searchForCustomers(industry, productVertical, customerTypes, constraints) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
     ...
     * Build Claude prompt for customer search
     */
    static buildCustomerSearchPrompt(industry, productVertical, customerTypes, constraints) {
        var _a;
        const maxResults = (constraints === null || constraints === void 0 ? void 0 : constraints.maxResults) || 10;
        const geography = ((_a = constraints === null || constraints === void 0 ? void 0 : constraints.geography) === null || _a === void 0 ? void 0 : _a.join(', ')) || 'United States';
...
Make sure the JSON is valid and properly formatted.`;
     ...
     */
    static parseClaudeCustomerResults(claudeResponse) {
        var _a;
        try {
            const content = (_a = claudeResponse.content[0]) === null || _a === void 0 ? void 0 : _a.text;
            if (!content) {
     ...
     */
    static getMockResults(industry, productVertical, constraints) {
        let mockResults = [];
        ...
        if (constraints === null || constraints === void 0 ? void 0 : constraints.maxResults) {
            filteredResults = filteredResults.slice(0, constraints.maxResults);
        }
        if ((constraints === null || constraints === void 0 ? void 0 : constraints.geography) && constraints.geography.length > 0) {
            filteredResults = filteredResults.filter(result => constraints.geography.some(geo => { var _a; return (_a = result.location) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(geo.toLowerCase()); }));
        }
        return filteredResults;
    }
}
exports.AIDiscoveryService = AIDiscoveryService;
