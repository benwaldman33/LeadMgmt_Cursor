...
async function main() {
  ...
  const dentalTeam = await prisma.team.create({
    data: {
  ...
  const healthcareTeam = await prisma.team.create({
    data: {
  ...
  const dentalAnalyst = await prisma.user.create({
    data: {
  ...
  const techAnalyst = await prisma.user.create({
    data: {
      email: 'tech@bbds.com',
  ...
  const dentalScoringModel = await prisma.scoringModel.create({
    data: {
  ...
  const healthcareScoringModel = await prisma.scoringModel.create({
    data: {
  ...
  const techScoringModel = await prisma.scoringModel.create({
    data: {
  ...
  const dentalCampaign = await prisma.campaign.create({
    data: {
  ...
  const techCampaign = await prisma.campaign.create({
    data: {
  ...
  const leadQualificationWorkflow = await prisma.workflow.create({
    data: {
      id: 'workflow-1',
  ...
  const dentalOnboardingWorkflow = await prisma.workflow.create({
    data: {
      id: 'workflow-2',
  ...
  console.log(`- ${await prisma.team.count()} teams created`);
  console.log(`- ${await prisma.campaign.count()} campaigns created`);
  console.log(`- ${await prisma.lead.count()} leads created`);
  console.log(`- ${await prisma.scoringModel.count()} scoring models created`);
  console.log(`- ${await prisma.scoringCriterion.count()} scoring criteria created`);
  console.log(`- ${await prisma.aIModel.count()} AI models created`);
  console.log(`- ${await prisma.businessRule.count()} business rules created`);
  console.log(`- ${await prisma.workflow.count()} workflows created`);
  console.log(`- ${await prisma.workflowStep.count()} workflow steps created`);
